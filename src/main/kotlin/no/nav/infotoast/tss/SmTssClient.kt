...
interface ISmTssClient {
    fun getTssId(fnr: String, orgnr: String, sykmeldingId: String): Result<TssIdent>
}
...
class SmTssClient(
    ...
    override fun getTssId(fnr: String, orgName: String, sykmeldingId: String): Result<TssIdent> {
        ...
        return try {
            ...
            when {
                status.value() == 404 -> {
                    teamLogger.warn("No tssId found for Sykmelder with fnr $fnr found in smtss. Body: $body", e)
